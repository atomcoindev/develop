...
QT_TRANSLATE_NOOP("bitcoin-core", "Attempt to recover private keys from a corruatcallet.dat"),
QT_TRANSLATE_NOOP("bitcoin-core", "Atomcoin version"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading wallet.dat: Wallet requires newer version of Atomcoin"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the Atomcoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Select the version of socks proxy to use (4-5, default: 5)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Send command to -server or atomcoind"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart Atomcoin to complete"),
